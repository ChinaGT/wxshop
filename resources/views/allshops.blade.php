            ...
            <div class="all-list-wrapper">
                ...
                <div class="menu-list-wrapper" id="divSortList">
                    <ul id="sortListUl" class="list">
                        ...
                        <input type="hidden" id="cate_id" value="{{$cate_id}}?:'0'">
                        @foreach($Cdata as $v)
                            @if($v->cate_id==$cate_id)
                                <li sortid='100' reletype='1' linkaddr='' class="cate current" cate_id="{{$v->cate_id}}"><span class='items'>{{$v->cate_name}}</span></li>
                            @else
                                <li sortid='100' reletype='1' linkaddr='' class="cate" cate_id="{{$v->cate_id}}"><span class='items'>{{$v->cate_name}}</span></li>
                            @endif
                        @endforeach
                    </ul>
                </div>
