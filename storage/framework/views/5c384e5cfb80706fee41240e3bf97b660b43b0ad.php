<?php /* /home/wwwroot/default/wxshop/resources/views/wechat/index.blade.php */ ?>
<!doctype html>
...
<head>
    ...
    <script src="<?php echo e(url('admin/lib/layui/layui.js')); ?>" charset="utf-8"></script>

    <script type="text/javascript" src="<?php echo e(url('admin/js/xadmin.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(url('admin/js/cookie.js')); ?>"></script>
    <script>
        // 是否开启刷新记忆tab功能
        ...
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a _href="<?php echo e(url('upload')); ?>">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加素材页面</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="<?php echo e(url('menuList')); ?>">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>菜单展示</cite>
                        </a>
                    </li >
        ...
        <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
          ...
          <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src="<?php echo e(url('welcome.blade.php')); ?>" frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
          </div>
          <div id="tab_show"></div>
        </div>
