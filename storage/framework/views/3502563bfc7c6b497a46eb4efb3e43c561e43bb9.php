<?php /* /home/wwwroot/default/wxshop/resources/views/login.blade.php */ ?>
...
<head>
    ...
    <link href="<?php echo e(url("/css/login.css")); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(url("/css/vccode.css")); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(url("/css/weui.css")); ?>" rel="stylesheet" >
</head>
<body>
...
<div class="wrapper">
    <div class="registerCon">
            ...
            <ul>
                <li class="accAndPwd">
                    ...
                    <dl>
                        ...
                        <img id="code" src="<?php echo e(url('code')); ?>" alt="">
                    </dl>
                </li>
            </ul>
        ...
        <div class="forget">
            <a href="https://m.1yyg.com/v44/passport/FindPassword.do">忘记密码？</a><b></b><a href="<?php echo e(url('/register')); ?>">新用户注册</a><br/><a href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx8ede1d5693643f15&redirect_uri=http%3A%2F%2Fgt.zty77.com%2Fdocodes&response_type=code&scope=snsapi_userinfo&state=admin123#wechat_redirect">微信登录</a>
        </div>
    </div>
...
<?php $__env->startSection('my-js'); ?>
    ...
    <script>
        ...
        $('#code').click(function(){
            $(this).attr('src',"<?php echo e(url('code')); ?>"+"?"+Math.random())
        })
        $(function () {
                    ...
                    success:function (msg) {
                        if(msg==1){
                            ...
                            layer.msg('登录成功',{icon:1,time:1000},function () {
                                location.href="<?php echo e(url('userpage')); ?>";
                            });
                        }else if(msg==4){
