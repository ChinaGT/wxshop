<?php /* /home/wwwroot/default/wxshop/resources/views/shopcart.blade.php */ ?>
...
<head>
    ...
    <link href="<?php echo e(url('/css/cartlist.css')); ?>" rel="stylesheet" type="text/css" />
</head>
    ...
    <input name="hidUserID" type="hidden" id="hidUserID" value="-1" />
        ...
        <div class="g-Cart-list">
            <ul id="cartBody">
                ...
                <li>
                    <s class="xuan current" goods_id="<?php echo e($v->goods_id); ?>"  price="<?php echo e($v->self_price); ?>"></s>
                    <a class="fl u-Cart-img" href="<?php echo e(url('shopcontent')); ?>/<?php echo e($v->goods_id); ?>">
                        <img src="<?php echo e($v->goods_img); ?>" border="0" alt="">
                    </a>
                    <div class="u-Cart-r">
                        <a href="<?php echo e(url('shopcontent')); ?>/<?php echo e($v->goods_id); ?>" class="gray6">(已更新至第<?php echo e($v->goods_id); ?>潮)<?php echo e($v->goods_name); ?></a>
                        <span class="gray9">
                            <em>价格(<?php echo e($v->self_price); ?>)元</em>
                        </span>
                        <div class="num-opt">
    ...
    <script>
        ...
        $(function () {
            $("#sub").click(function () {
                ...
                $.post(
                    "<?php echo e(url('index/total')); ?>",
                    {goods_id:goods_id,'_token':$("input[name=_token]").val()},
                    function (res) {
                        //console.log(res);
                        location.href="<?php echo e(url('index/totaldo')); ?>"
                    }
