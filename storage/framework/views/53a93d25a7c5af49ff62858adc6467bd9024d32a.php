<?php /* D:\phpStudy\PHPTutorial\WWW\wxshop\resources\views/index.blade.php */ ?>
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('layui/css/layui.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('layui/css/layui.css')); ?>">
    <link href="<?php echo e(url('css/comm.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(url('css/index.css')); ?>" rel="stylesheet" type="text/css" />
...
<body fnav="2" class="g-acc-bg">
	<div class="marginB" id="loadingPicBlock">
		...
		<div class="index-menu thin-bor-top thin-bor-bottom">
			<ul class="menu-list">
				...
				<?php $__currentLoopData = $Cdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<li>
						<a href="<?php echo e(url('/allshops')); ?>?cate_id=<?php echo e($v->cate_id); ?>" class=btnNew">
							<i class="xinpin"></i>
							<span class="title"><?php echo e($v->cate_name); ?></span>
						</a>
					</li>
		...
		<div class="success-tip">
			...
			<ul class="right-con">
				<?php $__currentLoopData = $Udata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<li>
					<span style="color: #4E555E;">
						<a href="/images/0.jpg" style="color: #4E555E;">微信公众上线了快点去关注</a>   
					</span>
				</li>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			</ul>
		...
		<div class="hot-wrapper">
			<ul class="clearfix">
				...
				<li>
					<a href="<?php echo e(url('shopcontent')); ?>/<?php echo e($v->goods_id); ?>">
						<p class="title"><?php echo e($v->goods_name); ?></p>
						<p class="subtitle"><?php echo e($v->goods_desc); ?></p>
			...
			<ul id="ulGoodsList" class="goods-list clearfix">
				<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<li id="23558" codeid="12751965" goodsid="23558" codeperiod="28436">
						...
						<p class="g-name"><a href="<?php echo e(url('shopcontent')); ?>/<?php echo e($v->goods_id); ?>">(第<em><?php echo e($v->goods_id); ?></em>潮)<?php echo e($v->goods_name); ?></a></p>
		...
		<div id="div_fastnav" class="fast-nav-wrapper">
			...
			<div class="sub-nav four" style="display: none;">
				...
				<a href="<?php echo e('quit'); ?>"><i class="announced"></i>退出</a><!--最新揭晓-->
			</div>
		</div>
	</div>
</body>
