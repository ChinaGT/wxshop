<?php /* /home/wwwroot/default/wxshop/resources/views/payment.blade.php */ ?>
<?php $__env->startSection('title','结算支付'); ?>
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('css/cartlist.css')); ?>">
...
<div>
                    ...
                    <a href="">
                        ...
                        <dl>
                            <dt>
                                    ...
                                    (第<?php echo e($v->goods_id); ?>潮)<?php echo e($v->goods_name); ?>
        ...
        <div class="g-Total-bt">
            <dd><a  href="<?php echo e(url('alipay')); ?>" class="orangeBtn fr w_account">立即支付</a></dd><!--id="btnPay"-->
        </div>
