<?php /* /home/wwwroot/default/wxshop/resources/views/shopcontent.blade.php */ ?>
...
<head>
    ...
    <link href="<?php echo e('/css/goods.css'); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e('/css/fsgallery.css'); ?>" rel="stylesheet" charset="utf-8">
    <link rel="stylesheet" href="<?php echo e('/css/swiper.min.css'); ?>">
    <style>
        ...
        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <section id="gallery" class="hotimg">
                        <ul class="slides" style="width: 600%; transition-duration: 0.4s; transform: translate3d(-828px, 0px, 0px);">
                            ...
                            <li style="width: 414px; float: left; display: block;" class="clone">
                                <a href="<?php echo e($v->goods_img); ?>">
                                    <img src="<?php echo e($v->goods_img); ?>" alt="">
                                </a>
                            </li>
                            <!--
                ...
                <div class="pro_info">
                    <h2 class="gray6">
                        ...
                        (第<em id='Period'><?php echo e($v['goods_id']); ?></em>潮)
                        <?php echo e($v['goods_name']); ?><span><?php echo e($v['goods_desc']); ?></span>
                    </h2>
                    <div class="purchase-txt gray9 clearfix">
                        价值：￥<?php echo e($v['self_price']); ?>
                    ...
                    <div class="swiper-wrapper">
                        <div class="record-wrapp swiper-slide">
                            ...
                            <div class="part-record">
                                <div class="ann_list">
                                    <div class="fl">
                                        <img src="<?php echo e('/images/goods2.jpg'); ?>" alt="">
                                    </div>
                                    <div class="fl">
                                        <h3>被小冉</h3>
...
<script src="<?php echo e('/js/jquery-1.11.2.min.js'); ?>"></script>
<script src="http://cdn.bootcss.com/flexslider/2.6.2/jquery.flexslider.min.js"></script>
<script src="<?php echo e('/js/swiper.min.js'); ?>"></script>
<script src="<?php echo e('/js/photo.js'); ?>" charset="utf-8"></script>
<script>
    wx.config({
        debug: false,
